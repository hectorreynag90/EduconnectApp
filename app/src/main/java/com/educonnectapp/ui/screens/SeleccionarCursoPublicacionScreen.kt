...
@Composable
fun SeleccionarCursoPublicacionScreen(
    tipo: String = "Tarea",
    ...
    onSeleccionar: (seccion: SeccionComunicadoItem) -> Unit = {}
) {
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = "¿PARA QUÉ CURSO DESEAS PUBLICAR?",
                fontFamily = Roboto,
                fontWeight = FontWeight.Bold,
                fontSize = 16.sp,
                color = TextBlue
    ...
    Row(
        ...
        Box(
            modifier = Modifier
                .size(64.dp)
                .background(
                    if (tipo == "Tarea") EduconnectBlueMedium else EduconnectBlue,
        ...
        Column(modifier = Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(3.dp)) {
            ...
            Box(
                modifier = Modifier
                    .background(EduconnectBlue.copy(alpha = 0.10f), RoundedCornerShape(20.dp))
                    .padding(horizontal = 10.dp, vertical = 3.dp)
            ) {
                Text(
                    text = "${item.cantidadAlumnos} alumnos",
                    fontFamily = Roboto,
...
@Composable
fun SeleccionarCursoPublicacionPreview() {
    EduConnectAppTheme {
        SeleccionarCursoPublicacionScreen(
            secciones = listOf(
                SeccionComunicadoItem(1L, "2do", "A", "Matemáticas", 28, 0),
                SeccionComunicadoItem(2L, "3er", "B", "Comunicación", 30, 0),
                SeccionComunicadoItem(3L, "4to", "C", "Ciencias", 25, 0)
            ),
        )
    }
}
